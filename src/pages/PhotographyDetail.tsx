...
import { Camera, Image, Video, Heart, Check, ArrowLeft, Calendar, Clock, Users, Zap } from "lucide-react";
...
const imageMap: Record<string, string[]> = {
  "wedding-photography": [photoBoothImg, booth360Img, backdropsImg, heroImageImg],
  "event-photography": [booth360Img, photoBoothImg, heroImageImg, backdropsImg],
  "portrait-photography": [backdropsImg, photoBoothImg, heroImageImg, booth360Img],
  "commercial-photography": [photoBoothImg, heroImageImg, backdropsImg, booth360Img],
};
...
export default function PhotographyDetail() {
  ...
  const { content: photography, loading: photographyLoading } = useContent<PhotographyType[]>('photography');

  const photo = photography?.find(p => p.slug === slug);
      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 pt-20 flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">Photography Service Not Found</h1>
            <p className="text-muted-foreground mb-6">The photography service you're looking for doesn't exist.</p>
            <Button asChild>
              <Link to="/photography">View All Services</Link>
            </Button>
          </div>
        </main>
        <Footer />
  ...
  const galleryImages = imageMap[photo.slug] || [photoBoothImg];
  const inclusions = photo.inclusions ? photo.inclusions.split(',').map(s => s.trim()) : [];
  const features = photo.features ? photo.features.split('|').map(f => {
    const [title, description] = f.split(':').map(s => s.trim());
    return { title, description: description || '' };
  }) : [];

  const highlights = [
    { icon: Clock, label: "Duration", value: photo.duration || "Custom" },
    { icon: Calendar, label: "Delivery Time", value: photo.deliveryTime || "1-2 weeks" },
    { icon: Users, label: "Min Booking", value: photo.minBooking || "2 hours" },
    { icon: Zap, label: "Service Type", value: photo.title },
  ];
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10 pt-32 pb-16">
            <div className="max-w-3xl">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-8 max-w-2xl">
                {photo.longDescription || photo.description}
              </p>
              ...
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-12">
                  <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
                    Why Choose <span className="text-primary">{photo.title}</span>?
                  </h2>
                  <p className="text-muted-foreground max-w-2xl mx-auto">
                    Discover what makes this service the perfect choice for your needs.
                  </p>
                </div>
              ...
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12">
                  ...
                  <p className="text-muted-foreground">
                    Everything you need for professional photography services.
                  </p>
                </div>
            ...
            <Card className="max-w-4xl mx-auto border-0 shadow-luxury bg-gradient-to-br from-primary/5 via-background to-secondary/5 overflow-hidden">
              <CardContent className="p-8 md:p-12 text-center relative">
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="font-display text-3xl md:text-4xl font-bold mb-4">
                    Ready to Book {photo.title}?
                  </h2>
                  <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
                    Let's capture your special moments. Contact us today for pricing and availability.
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Button 
                      ...
                      asChild
                    >
                      <Link to="/photography">Explore Other Services</Link>
                    </Button>
                  </div>
                </div>
              </CardContent>
